  ...
  <nav class="navbar navbar-default">
    ...
    <div class="container">
      <div class="cadastro">
        ...
        <form action="php/consultaMinhaVaga.php" method="POST">
          ...
          <div class="form-grup col-md-6  ">
            ...
            <input type="text" class="form-control" name="digVeiculo" maxlength="3">
          </div>
          <div class="form-group col-md-6 ">
            <label for="bloco">NUMEROS</label>
            <input type="text" class="form-control" name="numVeiculo" id="numVeiculos" maxlength="4">
          </div> 
          <div class="form-group col-md-3">

            <input class="form-control" type="submit" value="Consultar" name="buscar">
          </div> 
