...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="container" style="background-color:rgba(192,192,192,0.2); border-radius: 10px; ">
            <h3>1 - Efetue o dowload do arquivo em anexo e preencha os campos do formulário</h3>
            <h3>2 - Dirija-se a portaria e veja as datas disponiveis</h3>
           <!-- <input type="date" name="data">-->

            <a href="file/churrasqueira.pdf" class="btn btn-primary">download</a>
        </div>
